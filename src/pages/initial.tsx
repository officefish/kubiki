...
import Initial from '@/client/components/screens/initial'

const InitialPage: NextPageWithLayout<IBackendMinimum> = ({ host, port }) => {
...
InitialPage.getLayout = function getLayout(page: React.ReactElement) {
  return (
    <Providers themeProps={InitialPage.theme}>
      <BackendAddressProvider>
